...
import { Car, ShieldCheck, Headphones, Users, MapPin, Briefcase, Quote, Star } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {activeReviews.map((item, index) => (
            <div
              key={index}
              className="relative border border-blue-500 rounded-2xl bg-white"
            >
              
              <div className="absolute -top-8 right-8 w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center shadow-lg">
        ...
        <div className="flex justify-center items-center gap-6 mt-24">
          {reviewPages.map((_, index) => (
            <button
              ...
              className={`w-7 h-7 rounded-full border-[6px] border-blue-600 transition ${
