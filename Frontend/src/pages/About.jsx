			...
			<div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-stretch">
				...
				<div className="flex flex-col h-full">
					...
					<div>
						...
						<p className="mt-6 text-gray-600 text-lg leading-10">{about}</p>
						...
						<div className="grid md:grid-cols-2 gap-6 mt-14">
							...
							<div className="bg-white border rounded-2xl p-8 text-center shadow-sm">
								...
								<p className="text-gray-500 mt-6 leading-9 text-lg">
									To become the most trusted and preferred car rental service provider by
									continuously improving our services, embracing innovation and building
							...
							<div className="bg-white border rounded-2xl p-8 text-center shadow-sm">
								...
								<p className="text-gray-500 mt-6 leading-9 text-lg">
									To deliver convenient, affordable, and high-quality bike rental
									services that exceed customer expectations while ensuring safety,
									comfort, support and reliability in every ride.
								</p>
							</div>
						</div>
						...
						<p className="mt-12 text-gray-600 text-xl leading-10">
							...
							satisfaction, transparent pricing, and maintaining a fleet of vehicles
							that meet the highest standards. Your comfort and trust drive everything
							we do.
						</p>
					</div>
