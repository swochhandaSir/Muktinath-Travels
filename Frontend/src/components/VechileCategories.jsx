...
const VehicleCard = ({ vehicle }) => (
  <div className="h-full rounded-lg border border-blue-600 p-6">
    <div className="h-full w-full rounded-t-lg overflow-hidden">
      ...
      <div className="px-6 py-7 text-center">
        ...
        <div className="mt-6 grid grid-cols-2 gap-y-3 text-sm text-gray-500">
          <VehicleInfo icon={Car} text={vehicle.transmission} />
          <VehicleInfo icon={Fuel} text={vehicle.fuel} />
          <VehicleInfo icon={Car} text={vehicle.year} />
          <VehicleInfo icon={Gauge} text={vehicle.mileage} />
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            {vehicles.map((vehicle) => (
              <SwiperSlide key={vehicle.title} className="h-auto">
